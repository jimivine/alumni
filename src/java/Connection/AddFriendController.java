...
@WebServlet(name = "AddFriendController", urlPatterns = {"/services/friend.json"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        */
        ...
        try (PrintWriter out2 = response.getWriter()) {
            ...
            boolean createWorked = DBAccess.addFriend(username, friendsname); //Check login details
            if (createWorked == false) {
                out2.println("{\n"
                        + "    \"response\": \"fail\"\n"
                        + "}");
            } else {
